...
const WhyMe = () => {
    return (
        <div className='bg-[#f0f3ff] pt-[3.5rem] pb-[5rem]'>
            <div className='w-[83vw] mx-[auto] mt-[1.5rem] relative'>
            <h1 className='absolute top-0 left-0 right-0 mt-[-5.5rem] mx-auto text-center text-[7.5rem] font-semibold text-black opacity-[0.03]'>Services</h1>
                <h1 className='text-[3rem] font-semibold text-center text-black opacity-90'>Why Choose Me?<span className='text-[#f83b66]'>___</span></h1>
            ...
            <div className='grid grid-cols-3 mt-[3.5rem] gap-[2rem]'>
             <div className='col-span-1 bg-white px-[2rem] pb-[2rem]'>
